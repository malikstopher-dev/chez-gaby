...
const ITEMS = [
  { name: 'Homard', descFr: 'Homard grillé, beurre à l\'ail', descEn: 'Grilled lobster, garlic butter' },
  { name: 'Plateau Royal', descFr: 'Plateau de fruits de mer frais', descEn: 'Fresh seafood platter' },
  { name: 'Pieuvre Grillée', descFr: 'Pieuvre à la LORENA', descEn: 'Grilled octopus LORENA style' },
  { name: 'Saint-Jacques', descFr: 'Saint-Jacques façon NATHALIE', descEn: 'Scallops NATHALIE style' },
];
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {ITEMS.map((item, i) => (
            <motion.div
              ...
              className="glass rounded-2xl p-8 luxury-shadow hover:border-gold/20 transition-all duration-500 group"
            >
